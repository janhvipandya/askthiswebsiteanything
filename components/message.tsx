...
>
    <div className="p-6">
        ...
        <div className={cn("size-10 shrink-0 aspect-square rounded-full border border-zinc-700 bg-zinc-900 flex items-center justify-center", {
            "bg-blue-950 border-blue-700 text-zinc-200 flex items-center justify-center": isUserMessage
        }
            )}>
                {isUserMessage ? <User className="size-5" /> : <Bot className="size-5 text-white" />}
            </div>
            <div className="flex flex-col ml-6 w-full">
                <div className="flex items-centr space-x-2">
